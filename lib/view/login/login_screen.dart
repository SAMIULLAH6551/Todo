            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: [ Padding(
                  ...
                  child: Text(provider.emailMessage.toString(),style: TextStyle(
                    color: ColorConstant.red,
                  ),),
                ),
                  TextFieldWidget(controller: email, hintText: 'Enter Your Email Address', onchanged: (value) {
              ...
              Column(
                ...
                children: [
                   Padding(
                    ...
                    child: Text(provider.passwordMessage.toString(),style: TextStyle(color: ColorConstant.red),),
                  ),
                  TextFieldWidget(controller: password, hintText: 'Enter Your Password', onchanged: (value) {
